                ...
                <div class="col-md-6 col-sm-12">   
                    ...
                    <div class="card border-0 special-shadow">	
                        ...
                        <div class="card-body">                                                  
                            ...
                            <h3 class="text-center font-weight-bold fs-16 mb-4 mt-3">{{ __('License Activation') }} | <a style="color:red;" href="https://doniaweb.com" target="_blank">Licensed By DoniaWeB</a></h3>
